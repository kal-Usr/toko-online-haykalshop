<main role="main" class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <!-- Card Product Home page -->
            <div class="row">
                <?php foreach ($content as $row) : ?>
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <img src="<?= $row->image ? base_url("/assets/images/product/$row->image") : base_url("/assets/images/product/default.png") ?>" alt="" height="250" class="card-img-top" />
                            <div class="card-body">
